...
<html>
  <head>
	...
	<link href="media/css/jquery-ui-1.10.2.custom.min.css" type="text/css" rel="stylesheet">
    <style>
    ...
    <script>
		...
		function initialize() {
		  ...
		  kmlLayer = new google.maps.KmlLayer({
			url: 'http://tcdfame.cs.tcd.ie/kml_selector.php?year='+year+"&markers="+markers+"&s="+Math.random(),
