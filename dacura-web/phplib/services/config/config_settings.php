...
$settings = array(
		...
		"collections_datatable_init_string" =>'{ "jQueryUI": true, "searching": false, "info": true}',
		"default_collection_config" => array("a" => true, "b" => false),
		"default_dataset_config" => array("a" => true, "b" => false),
		"collection_paths_to_create" => array("datasets", "logs", "cache", "dumps", "schema"),
		"dataset_paths_to_create" => array("schema", "logs", "cache", "dumps", "schema"),
);
