...
class LDOUpdate extends DacuraObject{
	...
	/**
	 * Flips the update so that it appears in reverse - useful for rollbacks
	 */
	function flip(){
		$x = $this->original;
	...
	function sameAs(LDOUpdate &$other){
		return $this->forward == $other->forward && $this->meta == $other->meta;
	}
